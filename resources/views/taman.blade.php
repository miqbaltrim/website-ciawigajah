<meta charset="utf-8">
        ...
        <!-- Footer End -->
            ...
            <div class=" bg-violet-600 " style="background-image: url('/images/ciawigajah2.jpg'); background-size: cover; background-position: center; backdrop-filter: blur(50px); height:500px">
        ...
        <div class="max-w-5xl mx-auto mt-12 px-4 text-center">
            <div class="w-full max-w-6xl mx-auto">
                <h1 class="text-4xl font-bold mt-2 mb-6">Taman Sarongge</h1>
                <p class="px-4 leading-relaxed">
                Taman Sarongge, merupakan salah satu daya tarik wisata yang memukau di Desa Ciawi Gajah. Dengan latar belakang
                    alam yang memesona dan atmosfer yang tenang, taman ini menawarkan pengalaman yang menyegarkan bagi para
                    pengunjung yang mencari kedamaian dan keindahan alam. Dikelilingi oleh pepohonan hijau yang rimbun dan beragam
                    tanaman endemik, Taman Sarongge memberikan nuansa yang cocok untuk bersantai, berjalan-jalan santai, atau bahkan
                    berpiknik bersama keluarga dan teman-teman. Desain taman yang terencana dengan baik menciptakan sudut-sudut menarik
                    yang cocok untuk berfoto dan menciptakan kenangan indah. Pengunjung juga dapat menikmati fasilitas rekreasi seperti
                    area bermain anak-anak, jogging track, dan spot-spot pemandangan menakjubkan. Taman Sarongge tidak hanya menjadi tempat
                    rekreasi, tetapi juga cermin dari kekayaan alam dan upaya melestarikannya, sehingga menjadikannya destinasi wisata yang
                    patut dikunjungi di Desa Ciawi Gajah. Selain itu, di Taman Sarongge, Anda akan menemukan banyak spot foto yang menarik
                     dan Instagramable.
            </div>
        </div>
        <!-- Teks End -->
            ...
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                <div class="mb-4 flex items-center justify-between gap-8 sm:mb-8 md:mb-12">
                    <div class="flex items-center gap-12">
                        <h2 class="text-4xl font-bold mt-2 mb-6">Gallery Bank Sampah</h2>
                    </div>
                </div>
